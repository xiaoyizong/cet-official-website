...
export default function GlobalNetwork() {
  ...
  return (
    <section
      id="global-network"
      className="py-28 bg-[#0f2b4d] text-white overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="mt-5 text-gray-300 max-w-3xl mx-auto text-lg">
            Building long-term partnerships across Europe and Asia through
            trusted sourcing, premium products and international trade.
          </p>
        </motion.div>
